    ...
    <div class="bg-white border border-gray-200 rounded-b-2xl shadow-sm overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-slate-50">
                <tr>
                    <th class="px-6 py-4 text-left text-xs font-bold text-slate-500 uppercase">Equipamento</th>
                    <th class="px-6 py-4 text-left text-xs font-bold text-slate-500 uppercase">Tombo / Patrimônio</th>
                    <th class="px-6 py-4 text-left text-xs font-bold text-slate-500 uppercase">Nº de Série</th>
                    <th class="px-6 py-4 text-center text-xs font-bold text-slate-500 uppercase">Status</th>
                    <th class="px-6 py-4 text-center text-xs font-bold text-slate-500 uppercase">Entrada</th>
                </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-100">
                ...
                <tr class="hover:bg-blue-50/30 transition">
                    ...
                    <td class="px-6 py-4 text-sm font-bold text-red-600 bg-red-50/30">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-12 text-center">
                        ...
                        <p class="text-gray-500">Nenhum item encontrado para esta busca.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
